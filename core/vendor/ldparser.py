"""
=============================================================================
TERCEIRO (VENDORIZADO): ldparser.py
Fonte:    https://github.com/gotzl/ldparser  (autor: Matthias Gorzellik / gotzl)
Licenca:  GNU GPL v3.0 (texto completo em core/vendor/LICENSE-ldparser.txt)
Alteracoes: nenhuma - copia identica do arquivo original em master.

Este arquivo faz a decodificacao binaria dos .ld do MoTeC (usados pelo ACC
para telemetria detalhada). Nao foi escrito para este projeto - e reuso de
uma biblioteca de codigo aberto ja testada com arquivos da ACC.
IMPORTANTE (GPL): se este projeto for redistribuido publicamente, este
arquivo especifico continua sob GPL-3.0 e deve manter esta nota e a licenca
anexada. Para uso privado (voce e seus amigos), nao ha nenhuma obrigacao
adicional.
=============================================================================
"""
